 ...
 * You have to specify the content of the new allocted memory. That is important,
 ...
 *        for more informations see "man mprotect"
 */
 ...
 * ATTENTION: the page is only alloceted once. If you change it, a later call
 * to NULLpage returns the same changed memory region.
 *
 * @return pointer to getpagesize (normaly 4096) bytes that are all set to 0
 * @throws std::string in case of unsufficent memory
 */
const void* NULLpage();
