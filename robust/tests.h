 ...
 * No need to change.
 *
 * - specifies the test values for FILE* and const char*
 ...
 *   read the task description, use the forum or ask us
...
#define TC_FILE_RONLY 1
	{TC_FILE_RONLY, "FILE opend for reading only", EOF},
#define TC_FILE_WONLY 2
	{TC_FILE_WONLY, "FILE opend for writing only", 1},
#define TC_FILE_RW 3
	{TC_FILE_RW, "FILE opend for reading and writing", 1},
...
#define TC_FILE_MEM_INACCESSABLE 11
	{TC_FILE_MEM_INACCESSABLE, "pointer to inaccessable memory", EOF},
};
...
#define TC_CSTR_MEM_INACCESSABLE 7
	{TC_CSTR_MEM_INACCESSABLE, "pointer to inaccessable memory", EOF},
};
